<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="GestionarReservaCitas.aspx.cs" Inherits="App.UI.Clinica.GestionarReservaCitas" ClientIDMode="Static" %>
                                        ...
                                        <asp:GridView ID="grdHorariosAtencion" runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="false">
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HiddenField ID="hfIdMedico" runat="server" Value='<%#Eval("idMedico") %>' />
                                                        <asp:Label ID="lblMedico" runat="server" Text='<%#Eval("nombres") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
