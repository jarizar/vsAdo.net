$(function () {
    ...
    $("#personas").change(function () {
        $.ajax({
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                Mensaje("Error al consultar la persona", "error");
            }
        });
    });
    ...
    $("#btn_guardar").click(function (event) {
        ...
        swal({
            title: "Desea continuar?", type: "question", animation: false, showCancelButton: true, customClass: "animated tada"
        }).then((result) => {
            if (result.value) {
                ...
                $.ajax({
                    ...
                    error: function (jqXHR, textStatus, errorThrown) {
                        swal({ title: textStatus, type: "error", animation: false, customClass: 'animated hinge' });
                    }
                });
            }
        });
    ...
    $("#flecha_izquierda").click(function (event) {
        ...
        if (id_orden === "") {
            ...
            $.ajax({
                ...
                error: function () {
                    Mensaje("Error en la petición al servidor", "error");
                }
            });
        }
    });
